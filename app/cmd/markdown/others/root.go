...
type NewOtherCommand func(NewOtherCommandParams) *cobra.Command

type NewOtherCommandParams struct {
...
func createOtherCommand(params NewOtherCommandParams) *cobra.Command {

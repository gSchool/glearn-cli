...
func getTestCases() []testCase {
	return []testCase{
		{"lesson", "ls", NewLessonCommand, lessonTemplate, lessonTemplateMin},
		{"checkpoint", "cp", NewCheckpointCommand, checkpointTemplate, checkpointTemplateMin},
		{"survey", "sv", NewSurveyCommand, surveyTemplate, surveyTemplateMin},
		{"instructor", "in", NewInstructorCommand, instructorTemplate, instructorTemplateMin},
		{"resource", "rs", NewResourceCommand, resourceTemplate, resourceTemplateMin},
		{"fileheader", "fh", NewFileHeaderCommand, fileHeaderTemplate, fileHeaderTemplateMin},
	}
}
